...
# ANALYSES FOR SUBJECT-LEVEL DATA (TWO FORMS: 1 - col names are shared, each participant has 1-2 rows; 2 - each participant has 1 row, mult. sep. col. e.g. staisPhs1, staisPhs2)
# - Affective measures (STAIT, STAIS, PSS, UCLAL <--> perceived COVID risk) (overall correlogram)
