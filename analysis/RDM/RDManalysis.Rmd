...
pGamHighRiskDay = 1/(1+ exp(-1*(covRiskBeta*1 +  dayBeta*days + riskDayBeta*1*days)))
...
plot(pGamHighRiskDay, type="l", lwd = 7, ylim=c(.4,.6), col=colorOptions[1], xlab="day", ylab="probability of choosing gamble")
