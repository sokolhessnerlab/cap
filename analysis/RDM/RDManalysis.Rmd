...
# day(+) is trending (p=.064) as well as the interactio between poc, earnings and day (+, p=.07)
# everything else is not significant
...
# Summary: temporal context effects stronger as perceived covid risk increases
