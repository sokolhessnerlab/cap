...
capDataList = list(
  ...
  loss = abs(rdmBothQualtricsStan$rdmRiskyLoss),
...
stanModel = "/Users/sokolhessner/Documents/gitrepos/cap/analysis/RDM/stan/cap_basic0_rhoMuLambdaDB_faster.stan"
# stanModel = "/Users/sokolhessner/Documents/gitrepos/cap/analysis/RDM/stan/cap_basic0_rhoMuLambdaDB.stan"
...
# define some things
nChains = 2 # number of chains (1 chain per core)
fitSteps = 100 # stan will save half of this many x nChains per parameter
...
save(stanModel, sflistFinal, file = file.path(config$path$Rdata, 'stanModelOutput/cap_RhoMuLambdaDB_day+covRisk+Rho_%s.Rdata',format(Sys.Date(), format="%Y%m%d")))
