...
save(stanModel,sflistFinal, file = sprintf('cap_basicRhoMuLambdaBD_%s.Rdata',format(Sys.Date(), format="%Y%m%d")))
#save(stanMode, sflistFinal, file = file.path(config$path$Rdata, 'stanModelOutput/cap_basicRhoMuLambda_%s.Rdata',format(Sys.Date(), format="%Y%m%d")))
